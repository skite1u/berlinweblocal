    ...
    <div class="cookie-consent" id="cookieConsent" role="dialog" aria-modal="true" aria-labelledby="cookieTitle" hidden>
      <div class="cookie-card">
        <div>
          ...
          <p>Wir nutzen Google Analytics zur Reichweitenmessung. Die Analytics-Speicherung ist standardmäßig blockiert und wird erst nach deiner Zustimmung aktiviert.</p>
        </div>
